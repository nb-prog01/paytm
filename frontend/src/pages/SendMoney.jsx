        ...
        <div className="h-full flex flex-col justify-center">
            <div class="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                ...
                <div class="flex item-center space-x-4">
                    <div class="w-12 h-12 rounded-full bg-green-500 flex items-center justfy-center">
                ...
                <div class="space-y-4">
                    ...
                    class="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-ful bg-green-500 text-white">
                        Initiate Transfer
                    </button>
                </div>
                </div>
